...
export default function ProposalPreview({
  ...
  const subServiceTitle = ((proposal as any)?.subService || (deal as any)?.title || '').toLowerCase();
  ...
  const isCpmChillerManagement =
    ...
    serviceTitle.includes('chiller plant management') ||
    subServiceTitle.includes('chiller plant management') ||
