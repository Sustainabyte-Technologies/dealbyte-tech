...
export function NitrogenGasLeakageAuditPages({
    ...
    <div className="flex flex-col sm:flex-row sm:items-start justify-between border-b border-slate-200 pb-2.5 gap-4">
      <div>
        ...
        <h2 className="text-base sm:text-lg font-black text-slate-900 mt-0.5">
          {deal?.clientName || 'Valued Client'} — Nitrogen Gas Leakage Audit
        </h2>
  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between gap-4 pb-3 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-600 font-medium mt-0.5">
                  Service Scope: <span className="font-bold text-slate-800">Energy Audit Services — Nitrogen Gas Leakage Audit</span>
                </p>
              </div>
      ...
      {/* ── PAGE 2: LEAKAGE IDENTIFICATION & LEAKAGE DETECTOR OVERVIEW ── */}
      <PageShell pageNum={2} subtitle="Scope of Work: Leakage Identification & Detection Technology">
        <div className="space-y-3.5 text-slate-900 text-left font-normal text-[11px] leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-1.5 text-slate-800 text-[10.5px]">
              <p className="flex items-start gap-2">
                ...
                <span>Leakage identification and tagging is a systematic approach to controlling gas losses.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">•</span>
                <span>During an audit, each leakage point is detected using ultrasonic detectors and then physically tagged with a unique identification label.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">•</span>
                <span>This tagging ensures that every leak location is documented, prioritized, and can be easily tracked for repair.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">•</span>
                <span>By tagging each leak point, <em>plants gain a clear action plan for maintenance teams</em>, enabling them to fix the leaks in a structured way instead of random patchwork.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">•</span>
                <span>This process not only quantifies the cost of each leakage but also helps in monitoring recurring problem areas, ensuring long-term energy savings and reliable system performance.</span>
              </p>
            </div>

            {/* Visual Images Side by Side: Acoustic Camera + Physical Leak Tag (matching screenshot) */}
            <div className="grid grid-cols-2 gap-4 pt-3">
              <div className="flex justify-center">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/compress ai1.png"
                  alt="Acoustic Imager Screen"
                  className="w-full h-auto max-h-[160px] object-contain rounded border border-slate-200 shadow-xs"
                />
              </div>
          ...
          <div className="pt-2 border-t border-slate-200">
            ...
            <div className="space-y-1 text-slate-800 text-[10px]">
              ...
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">▪</span>
                <span><strong className="text-slate-950 font-bold">Portability &amp; Power</strong> – Lightweight, handheld device powered by <strong className="text-slate-950">rechargeable or replaceable batteries</strong> with <strong className="text-slate-950">6–10 hours’ runtime</strong>.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-slate-900 font-bold shrink-0">▪</span>
                <span><strong className="text-slate-950 font-bold">Applications</strong> – Used for <strong className="text-slate-950">compressed air systems, gas pipelines, vacuum systems, steam traps, and refrigerant leak detection</strong> without interrupting operations</span>
              </p>
            </div>

            {/* Centered Detector Device Image (matching screenshot) */}
            <div className="pt-2 flex justify-center">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/compressed 3.png"
                alt="Precision Acoustic Ultrasonic Leak Detector in Operation"
                className="w-full h-auto max-h-[175px] max-w-[360px] object-cover rounded-lg border border-slate-200 shadow-xs"
              />
            </div>
          </div>
        </div>
      ...
      <PageShell pageNum={3} subtitle="Commercial Investment, Terms & Authorization">
        <div className="space-y-4 text-slate-900 text-left font-normal text-[11px] leading-relaxed">
          ...
          <div>
            <h3 className="font-bold text-slate-950 underline underline-offset-4 decoration-2 decoration-slate-900 text-sm mb-2">
              Nitrogen Gas Leakage Audit Commercials:
            </h3>
                  ...
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="py-3 px-4 font-semibold text-slate-900 leading-relaxed align-top">
                      ...
                      <ul className="space-y-0.5 pl-3 text-[10.5px] text-slate-700 font-normal list-disc">
                        ...
                        <li>Actionable rectification plan, replacement recommendations &amp; comprehensive report</li>
                      </ul>
                    </td>
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-1 pl-4 text-slate-800 text-[10.5px]">
              ...
              <p className="flex items-start gap-1.5">
                <span className="text-slate-900 font-bold">•</span>
                <span>1 person required from client side with knowledge on gas line to reach out from the generation to end use for leakage identifications.</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-1 pt-2 border-t border-slate-200">
            ...
            <div className="space-y-0.5 text-xs text-slate-900">
              <p className="font-black text-slate-950">Thanakarthik Kumar</p>
